...
public class MasterMind extends SuperMasterMind implements InterfaceJuegos {
	...
	private static final String quepena = "LO SENTIMOS. No has conseguido acertar la combinación en la partida nº ";
	private static final String quebien = "¡ENHORABUENA! Has acertado la combinación en ";
...
pedirJugada (i);
	...
	/* (non-Javadoc)
	 * @see paqueteMasterMind.InterfaceJuegos#visualizarSalida(boolean, int, java.lang.String)
	 */
	@Override
	...
	private void pedirJugada (int j) throws IOException {
		int i;
		for (i=0; i<=4; i++) {
			System.out.println (MasterMind.INICIALCOLOR + (i+1) +": ");
	...
	/* (non-Javadoc)
	 * @see paqueteMasterMind.InterfaceJuegos#modificarHeridos(int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, long, java.lang.String)
	 */
	@Override
	public long modificarHeridos(int numRM, int numVM, int numAM, int numBM,
			...
			int numMJugada, int numGJugada, int numSJugada, long heridos, String newParam) {
